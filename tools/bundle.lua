...
local profiles = {
    kernel = {
        modules = {
            ...
            ["kernel.chacha20"]  = "src/kernel/chacha20.lua",
            ["kernel.random"]    = "src/kernel/random.lua",
